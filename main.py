            ...
            if st.button("Buscar Tabelas Válidas ➡️", type="primary"):
                with st.spinner("O Especialista está escaneando os arquivos..."):
                    ...
                    for arquivo in arquivos:
                        ...
                        try:
                            # Passamos a variável 'arquivo' diretamente pro Pandas!
                            if ext == 'csv':
                                ...
                                motor = 'openpyxl'
                                if ext == 'xls': motor = 'xlrd'
                                elif ext == 'xlsb': motor = 'pyxlsb'
                                
                                dict_abas = pd.read_excel(arquivo, sheet_name=None, header=None, engine=motor)
                            ...
                            st.error(f"🚨 Falha crítica no arquivo: {nome_curto}")
                            st.warning("O Python ocultou a mensagem simples. Abaixo está o Raio-X exato do erro técnico:")

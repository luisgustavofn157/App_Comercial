import pandas as pd
from tratamento_de_dados.silver.consultor_memoria import consultar_memoria, normalizar_termo
from tratamento_de_dados.silver.heuristicas import numericas, textuais, financeiras, lexical
